    ...
    <>
      ...
      <div className="checkout-content">
        ...
        <div className="jumbotron padding-jumbotron">
          ...
          <button type="button" class="btn btn-warning shipping-method" onClick={showGetOnStore}>Retirada em loja</button>
          <hr></hr>
          <button type="button" class="btn btn-warning shipping-method" onClick={showDelivery}>Envio para endereço</button>
        </div>

        {getOnStore && (
          <>
            <hr></hr>
            <span>Você selecionou <strong>Retirada em loja</strong></span>
            ...
            <hr></hr>
            <button type="button" class="btn btn-success finish-order-checkout" onClick={finishOrder}><strong>Finalizar pedido</strong></button>
          </>
        )}
