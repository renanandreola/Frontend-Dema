...
function Checkout() {
  ...
  function finishOrder() {
    ...
    var message =
      "Olá, vim pelo seu site! Gostaria de retirar: \n" +
      products +
      "no total de " +
        ...
        <div className="checkout-content">
          ...
          <div className="m-1">
            ...
            <div className="alert alert-warning mt-4" role="alert">
              ...
              RS. Para envios fora desta localidade, selecione{" "}
              <strong>"Envio para endereço"</strong> para entrar em contato com
              a nossa equipe.
            </div>

            <div className="checkout-options">
              <div className="jumbotron padding-jumbotron adjust-jumbotron">
                ...
                <button
                  type="button"
                  className="btn btn-warning shipping-method"
                  onClick={showGetOnStore}
                >
                  Retirada em loja
                </button>
            ...
            {getOnStore &&
              (isMobile ? (
                <>
                  ...
                  <span className="text-address-selected">
                  ...
                  <span className="address-dema">
                    R. Alm. Barroso - Centro, Erechim - RS, 99700-122
                  </span>

                  <div className="alert alert-primary mt-4" role="alert">
                    Ao finalizar seu pedido, você será redirecionado para o
                    contato de nossa loja, podendo assim agendar sua retirada.
                  </div>
                  ...
                  <button
                    type="button"
                    className="btn btn-success finish-order-checkout"
                    onClick={finishOrder}
                  >
                ...
                <>
                  ...
                  <div className="content-finish-checkout-desk">
                    <div
                      className="alert alert-primary mt-4 alert-custom-checkout-desk"
                      role="alert"
                    >
                      Ao finalizar seu pedido, você será redirecionado para o
                      contato de nossa loja, podendo assim agendar sua retirada.
                ...
                <div>
                  ...
                  {showAddressData && addressData && (
                    <div className="address-data">
                      <div className="card">
                        <div className="card-header">{addressData.name}</div>
                        <div className="card-body">
                          <h5 className="card-title">
                            {addressData.address1}, n°{addressData.address2}
                          </h5>
                          <p className="card-text">
                            {addressData.postalCode}, {addressData.county},{" "}
                  ...
                  <form onSubmit={createLogin}>
                    ...
                    <div className="">
                      <button
                        type="submit"
                        className="btn btn-success verifyIdentity"
                      >
                        Verificar
                      </button>
                    </div>
