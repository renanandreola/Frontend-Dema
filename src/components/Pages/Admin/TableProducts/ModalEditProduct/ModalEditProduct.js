            ...
            <form className='form-custom-modal' onSubmit={handleSubmit}>
                <div className='card-form-modal'>
                    ...
                    <div className='content-form-modal'>
                        ...
                        <input className='input-add-products-modal' type="text" name="name" value={form.name} onChange={handleChange} required />
                    </div>

                    <div className='content-form-modal'>
                        <span className='span-label-modal'>Preço:</span>
                        <input className='input-add-products-modal' type="number" name="price" value={form.price} onChange={handleChange} required />
                        <span className='small'>Não adicione números negativos</span>
                    </div>

                    <div className='content-form-modal'>
                        <span className='span-label-modal'>Descrição:</span>
                        <textarea className='textarea-custom-modal' type="text" name="description" value={form.description} onChange={handleChange} required />
                    </div>

                    <div className='content-form-modal'>
                        <span className='span-label-modal'>Imagem:</span>
                        <input className='input-add-products-modal' type="text" name="image" value={form.image} onChange={handleChange} required />
                        <span className='small'>Adicione o link da imagem</span>
                    </div>

                    <div className='content-form-modal'>
                        <span className='span-label-modal'>Qtd. em estoque:</span>
                        <input className='input-add-products-modal' type="number" name="stock" value={form.stock} onChange={handleChange} required />
                        <span className='small'>Não adicione números negativos</span>
                    </div>

                    <div className='content-form-checkbox-modal'>
                        <span className='span-label-modal'>Tem promoção?:</span>
                        <input className='input-add-products-checkbox-modal' type="checkbox" name="hasPromotion" checked={form.hasPromotion} onChange={handleChange} />
                    </div>

                    {form.hasPromotion && (
                        <div className='content-form-modal'>
                            <span className='span-label-modal'>Preço promocional:</span>
                            <input className='input-add-products-modal' type="number" name="pricePromotion" value={form.pricePromotion} onChange={handleChange} required />
                            <span className='small'>Não adicione números negativos</span>
                        </div>
                    )}

                    <button className='btn btn-success' type="submit">Editar produto</button>
                </div>
            </form>
        </div>
    );
