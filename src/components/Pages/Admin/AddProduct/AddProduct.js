    ...
    <form className='form-custom' onSubmit={handleSubmit}>
      <div className='card-form'>
        <div className='content-form'>
          ...
          <input className='input-add-products' type="text" name="name" value={form.name} onChange={handleChange} required />
        </div>

        <div className='content-form'>
          <span className='span-label'>Preço:</span>
          <input className='input-add-products' type="number" name="price" value={form.price} onChange={handleChange} required />
          <span className='small'>Não adicione números negativos</span>
        </div>

        <div className='content-form'>
          <span className='span-label'>Descrição:</span>
          <textarea className='textarea-custom' type="text" name="description" value={form.description} onChange={handleChange} required />
        </div>

        <div className='content-form'>
          <span className='span-label'>Imagem:</span>
          <input className='input-add-products' type="text" name="image" value={form.image} onChange={handleChange} required />
          <span className='small'>Adicione o link da imagem</span>
        </div>

        <div className='content-form'>
          <span className='span-label'>Qtd. em estoque:</span>
          <input className='input-add-products' type="number" name="stock" value={form.stock} onChange={handleChange} required />
          <span className='small'>Não adicione números negativos</span>
        </div>

        <div className='content-form-checkbox'>
          <span className='span-label'>Tem promoção?:</span>
          <input className='input-add-products-checkbox' type="checkbox" name="hasPromotion" checked={form.hasPromotion} onChange={handleChange} />
        </div>

        {form.hasPromotion && (
          <div className='content-form'>
            <span className='span-label'>Preço promocional:</span>
            <input className='input-add-products' type="number" name="pricePromotion" value={form.pricePromotion} onChange={handleChange} required />
            <span className='small'>Não adicione números negativos</span>
          </div>
        )}
