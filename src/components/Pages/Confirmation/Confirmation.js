    ...
    <>
      ...
      <div className="checkout-content">
        ...
        <div className="progress">
            <div className="progress-bar progress-bar-striped bg-warning progress-bar-animated checkout" role="progressbar" aria-valuenow="75" aria-valuemin="0" aria-valuemax="100">100%</div>
        </div>
        ...
        <a href="/">
            <button type="button" class="btn btn-warning finish-order-checkout"><strong>Voltar para o início</strong></button>
        </a>
