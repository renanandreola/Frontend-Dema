        ...
        <div className="content-cart-desk">
          ...
          <div className="m-1">
              ...
              <div className="cart-content">
                ...
                <div className="cart-right">
                  ...
                  <div className="product-total">
                    ...
                    <span className="text-cart">
                      <strong>
                        {formatCurrency(product.qtd * product.price)}
                      </strong>
                    </span>
                  </div>
                </div>
            ...
            <div className="alert alert-warning mt-4" role="alert">
              Os itens selecionados estão sujeitos à confirmação de estoque e
              serão reservados em um momento posterior à conclusão da compra.
            </div>
            ...
            <div>
              <a href="/checkout">
                <button
                  type="button"
                  className="btn btn-warning finish-order-btn"
                >
          ...
          <div className="m-1">
            ...
            <div className="cart-content-desk">
              <div className="cart-content-desk-left">
                ...
                <div className="alert alert-warning mt-4" role="alert">
                  Os itens selecionados estão sujeitos à confirmação de estoque
                  e serão reservados em um momento posterior à conclusão da
                  compra.
                </div>
              ...
              <div className="cart-content-desk-right">
                <div className="jumbotron padding-jumbotron">
                  <span className="cart-resume-title">RESUMO DO CARRINHO</span>
                  <ul className="list-group list-group-flush width-list-cart">
                    <li className="list-group-item align-list-custom">
