...
function ProductDetails(props) {
  ...
  if (
    ...
    baseURL = "https://dema-api.vercel.app/dema/product";
  }
        ...
        {loading ? (
          ...
          <div className="m-1">
            ...
            <div className="breadcrumb-custom breadcrumb-pdp">
              ...
              <a href="/product-details" className="text-breadcrumb">
                Produto
              </a>
              <div className="arrow-content">
                <svg
            ...
            <div>
              <div className="product-info-pdp">
                ...
                <div className="product-actions">
                  ...
                  <button
                    className="btn btn-warning add-cart-custom-pdp"
